...
import { Calendar as CalendarIcon, RefreshCw, Circle, Square } from 'lucide-react';
import TianDiPan from '../components/TianDiPan';
import TianDiPanSquare from '../components/TianDiPanSquare';
...
export default function DaLiuRenPage() {
  ...
  const [panStyle, setPanStyle] = useState<'circle' | 'square'>('circle');
        ...
        <header className="text-center mb-8">
          ...
          <div className="mt-6 space-y-3">
            ...
            <div className="flex flex-wrap gap-x-4 gap-y-1 justify-center text-xs text-gray-500">
              ...
              <a
                href="https://github.com/jingrongx/liuren/releases/latest"
                target="_blank"
                rel="noopener noreferrer"
                onClick={(e) => { e.preventDefault(); openUrl('https://github.com/jingrongx/liuren/releases/latest'); }}
                className="hover:text-gray-700 underline decoration-dotted"
              >
                GitHub EXE
              </a>
